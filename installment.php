<?php
  ...
  $sqls = "select car_no from new_car_info where car_no= '".$car_no."' and status='sold' ";
                         ...
                         <div class="card-body bg-light">
                            <form class="text-left text-light" action="installment_add.php" method="POST">
                                ...
                                <div class="form-group">
                                  ...
                                  <input name="cash_received" type="number" class="form-control" required>
                                </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <input name="date_inst" type="date" class="form-control" required>
                                </div>
