                         ...
                         <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                             <div>
                                 <h3 class="fs-2"><?php
                                     ...
                                     $sql = "SELECT * FROM new_car_info where status='sold' AND car_no= '".$car_no."' AND year= '".$year."' ";
                         ...
                         <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                             <div>
                                 <h3 class="fs-2">
                                   ...
                                   $query_due_sum= "select SUM(sprice) AS sum FROM customer_details where car_no= '".$car_no."' AND  year= '".$year."'";
                       ...
                       <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                           <div>
                               <h3 class="fs-2"><?php
                                   ...
                                   $sql = "SELECT * FROM new_car_info where status='unsold' AND car_no= '".$car_no."' AND  year= '".$year."'";
                                   if ($result=mysqli_query($conn,$sql)) {
                                     $rowcount=mysqli_num_rows($result);
                                     echo $rowcount;
                                   }
                       ...
                       <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                           <div>
                               <h3 class="fs-2"><?php
                                   ...
                                   $query= "select SUM(price) AS sum FROM new_car_info where car_no= '".$car_no."' AND  year= '".$year."'";
                            ...
                            <div class="row">
                              <table id="myTable" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                  <?php
                                    include_once('db.php');
                                    $sql = "select * from ".$car_no." where status= 'unsold'  AND year= '".$year."' ";
                                    $sl=0;
                                    $total_profit=0;
                                    //use for MySQLi-OOP
