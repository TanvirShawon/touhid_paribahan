...
if(isset($_POST['Submit'])){
  ...
  if (mysqli_num_rows($results) > 0) {
    ...
    header("Location: yearly.php?message=No record found!");
  }
}
                         ...
                         <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                             <div>
                                 <h3 class="fs-2"><?php
                                     ...
                                     $sql = "SELECT * FROM new_car_info where status='sold' AND car_no= '".$car_no."' ";
                         ...
                         <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                             <div>
                                 <h3 class="fs-2">
                                   ...
                                   $query_due_sum= "select SUM(sprice) AS sum FROM customer_details where car_no= '".$car_no."' ";
                         ...
                         <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                             <div>
                                 <h3 class="fs-2">
                                   ...
                                   <?php
                                   $total_profit = 0;
                                   $query= "select car_no from new_car_info where car_no= '".$car_no."'";
                       ...
                       <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                           <div>
                               <h3 class="fs-2"><?php
                                   ...
                                   $sql = "SELECT * FROM new_car_info where status='unsold' AND car_no= '".$car_no."' ";
                                   if ($result=mysqli_query($conn,$sql)) {
                                     $rowcount=mysqli_num_rows($result);
                                     echo $rowcount;
                                   }
                       ...
                       <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                           <div>
                               <h3 class="fs-2"><?php
                                   ...
                                   $query= "select SUM(price) AS sum FROM new_car_info where car_no= '".$car_no."' ";
                                   $query_result = mysqli_query ($conn, $query);
                 ...
                 <div class="container mt-5 mb-3">
                   <div class="row justify-content-center">
                     <div class="col-md-3">
                            ...
                            <form class="text-left text-light" action="yearly_query2.php" method="POST">
