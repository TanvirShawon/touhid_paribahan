                       ...
                       <div class="bg-white" id="sidebar-wrapper">
                         <a href="index.php" class="text-decoration-none"><div class="sidebar-heading text-center py-4 primary-text fs-4 fw-bold text-uppercase border-bottom"><i
                           ...
                           <div class="list-group list-group-flush my-3">
                               ...
                               <a href="daily_expense.php" class="list-group-item list-group-item-action bg-transparent second-text active"><i
                                 ...
                                 <div class="col-md-6">
                                   <div class="card">
                                     ...
                                     <div class="card-body bg-light">
                                        <form class="text-left text-light" action="daily_expense_add.php" method="POST">
                                            <div class="form-group">
                                              <label class="text-dark">Enter Car no.</label>
                                              <input name="car_no" type="text" class="form-control" required>
                                            </div>

                                            <div class="form-group">
                                              <label class="text-dark">Expense</label>
                                              <input name="expense" type="text" class="form-control" required>
                                            </div>

                                            <div class="form-group">
                                              <label class="text-dark">Earn</label>
                                              <input name="earn" type="text" class="form-control" required>
                                            </div>
