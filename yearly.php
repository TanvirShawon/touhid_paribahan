        ...
        <div class="bg-white" id="sidebar-wrapper">
          <a href="index.php" class="text-decoration-none"><div class="sidebar-heading text-center py-4 primary-text fs-4 fw-bold text-uppercase border-bottom"><i
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <a href="yearly.php" class="list-group-item list-group-item-action bg-transparent second-text active"><i
                        ...
                        <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                            <div>
                                <h3 class="fs-2"><?php
                                    ...
                                    $sql = "SELECT * FROM new_car_info where status='sold' AND year= '".$year."' ";
                        ...
                        <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                            <div>
                                <h3 class="fs-2">
                                  ...
                                  $query_due_sum= "select SUM(sprice) AS sum FROM customer_details where year= '".$year."' ";
                            ...
                            <div>
                                <h3 class="fs-2">
                                  ...
                                  while ($row = mysqli_fetch_assoc($query_result)){
                                    ...
                                    $query_total_profit= "select SUM(cash_received) AS sum FROM ".$car_no." where iyear= '".$year."'";
                      ...
                      <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                          <div>
                              <h3 class="fs-2"><?php
                                  ...
                                  $sql = "SELECT * FROM new_car_info where status='unsold'  AND year= '".$year."'";
                                  if ($result=mysqli_query($conn,$sql)) {
                                    $rowcount=mysqli_num_rows($result);
                                    echo $rowcount;
                                  }
                      ...
                      <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                          <div>
                              <h3 class="fs-2"><?php
                                  ...
                                  $query= "select SUM(price) AS sum FROM new_car_info where status='unsold'  AND year= '".$year."' ";
                                  $query_result = mysqli_query ($conn, $query);
                      ...
                      <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                          <div>
                              ...
                              while ($row = mysqli_fetch_assoc($query_result)){
                                ...
                                $query_total_profit= "select SUM(total_profit) AS sum FROM ".$car_no." where year= '".$year."'";
                                $query_result1 = mysqli_query ($conn, $query_total_profit);
                ...
                <div class="container mt-5 mb-3">
                  <div class="row justify-content-center">
                    <div class="col-md-3">
                           ...
                           <form class="text-left text-light" action="yearly_query.php" method="POST">


                               <div class="form-group">
                                 <label class="text-dark fw-bold">Select Year</label>
                         ...
                         <div class="col-md-3">
                                ...
                                <form class="text-left text-light" action="yearly_car_query.php" method="POST">
