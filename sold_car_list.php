...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM new_car_info WHERE status='sold' AND CONCAT(`id`, `car_name`, `car_no`, `price`) LIKE '%".$valueToSearch."%'";
    $search_result = filterTable($query);

}
 else {
    $query = "SELECT * FROM new_car_info WHERE status='sold' ";
    $search_result = filterTable($query);
}
        ...
        <div class="bg-white" id="sidebar-wrapper">
          <a href="index.php" class="text-decoration-none"><div class="sidebar-heading text-center py-4 primary-text fs-4 fw-bold text-uppercase border-bottom"><i
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <a href="sold_car_list.php" class="list-group-item list-group-item-action bg-transparent second-text active"><i
                                        ...
                                        <td><a href="<?php echo $statusLink; ?>" title="<?php echo $statusTooltip; ?>">
                                          <span class="badge <?php echo ($row['status'] == 'sold')?'badge-success':'badge-danger'; ?>">
                                            ...
                                            <td class="text-center">
                                              ...
                                              <a href="edit_sold_car.php?car_no=<?php echo $row['car_no'] ?>" class="btn btn-info"><i class="fa fa-user-edit"></i></a>
                                              <a href="delete_car.php?delete=<?php echo $row['car_no'] ?>" class="btn btn-danger" onclick="return confirm('Are you sure to delete this record?')"><i class="fa fa-trash-alt"></i></a>
                                              <a href="installment.php?car_no=<?php echo $row['car_no'] ?>" class="badge text-dark 'badge-danger'">Installemnt</a >
